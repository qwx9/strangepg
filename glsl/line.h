...
/*
    ...
    Cmdline:
        sokol-shdc -f sokol_impl -i glsl/line.glsl -l glsl430:hlsl5:metal_macos:glsl300es -o glsl/line.h

    Overview:
    =========
    Shader program: 's':
        Get shader desc: line_s_shader_desc(sg_query_backend());
        Vertex Shader: vs
        Fragment Shader: fs
        Attributes:
            ATTR_line_s_pos => 0
    ...
    Bindings:
        Uniform block 'Vparam':
            C struct: line_Vparam_t
            Bind slot: UB_line_Vparam => 0
*/
...
#endif
#endif
const sg_shader_desc* line_s_shader_desc(sg_backend backend);
#define ATTR_line_s_pos (0)
#define ATTR_line_s_color (1)
#define UB_line_Vparam (0)
#pragma pack(push,1)
SOKOL_SHDC_ALIGN(16) typedef struct line_Vparam_t {
    float mvp[16];
} line_Vparam_t;
#pragma pack(pop)
...
/*
    ...
    void main()
    {
        gl_Position = mat4(Vparam[0], Vparam[1], Vparam[2], Vparam[3]) * pos;
        col0 = color;
        gl_Position.z = 2.0 * gl_Position.z - gl_Position.w;
    }

*/
static const uint8_t line_vs_source_glsl430[312] = {
    ...
    0x30,0x20,0x3d,0x20,0x63,0x6f,0x6c,0x6f,0x72,0x3b,0x0a,0x20,0x20,0x20,0x20,0x67,
...
*/
static const uint8_t line_fs_source_glsl430[121] = {
...
*/
static const uint8_t line_vs_source_glsl300es[326] = {
    ...
    0x20,0x76,0x65,0x63,0x34,0x20,0x70,0x6f,0x73,0x3b,0x0a,0x6f,0x75,0x74,0x20,0x6d,
    ...
    0x2a,0x20,0x70,0x6f,0x73,0x3b,0x0a,0x20,0x20,0x20,0x20,0x63,0x6f,0x6c,0x30,0x20,
...
*/
static const uint8_t line_fs_source_glsl300es[149] = {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x30,0x30,0x20,0x65,0x73,0x0a,
...
*/
static const uint8_t line_vs_source_hlsl5[710] = {
    ...
    0x20,0x67,0x6c,0x5f,0x50,0x6f,0x73,0x69,0x74,0x69,0x6f,0x6e,0x20,0x3d,0x20,0x6d,
    0x75,0x6c,0x28,0x70,0x6f,0x73,0x2c,0x20,0x5f,0x31,0x39,0x5f,0x6d,0x76,0x70,0x29,
    ...
    0x30,0x20,0x3d,0x20,0x63,0x6f,0x6c,0x30,0x3b,0x0a,0x20,0x20,0x20,0x20,0x72,0x65,
...
*/
static const uint8_t line_fs_source_hlsl5[400] = {
...
*/
static const uint8_t line_vs_source_metal_macos[489] = {
    ...
    0x6f,0x75,0x74,0x2e,0x63,0x6f,0x6c,0x30,0x20,0x3d,0x20,0x69,0x6e,0x2e,0x63,0x6f,
...
*/
static const uint8_t line_fs_source_metal_macos[301] = {
    0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,0x20,0x3c,0x6d,0x65,0x74,0x61,0x6c,0x5f,
    0x73,0x74,0x64,0x6c,0x69,0x62,0x3e,0x0a,0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,
    0x20,0x3c,0x73,0x69,0x6d,0x64,0x2f,0x73,0x69,0x6d,0x64,0x2e,0x68,0x3e,0x0a,0x0a,
    0x75,0x73,0x69,0x6e,0x67,0x20,0x6e,0x61,0x6d,0x65,0x73,0x70,0x61,0x63,0x65,0x20,
...
const sg_shader_desc* line_s_shader_desc(sg_backend backend) {
    if (backend == SG_BACKEND_GLCORE) {
        ...
        if (!valid) {
            valid = true;
            desc.vertex_func.source = (const char*)line_vs_source_glsl430;
    ...
    if (backend == SG_BACKEND_GLES3) {
        ...
        if (!valid) {
            valid = true;
            desc.vertex_func.source = (const char*)line_vs_source_glsl300es;
            desc.vertex_func.entry = "main";
